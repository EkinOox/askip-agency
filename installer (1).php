...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220313_askip_25cb5a9665ffedd82050_20220313133013_archive.zip';
	const ARCHIVE_SIZE		 = '723361498';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '25cb5a9-13133013';
    const SECONDARY_PACKAGE_HASH = '0535cf4-13133013';
	const VERSION			 = '1.4.4';
